...
mkdir $ClangPath
rm -rf $ClangPath/*
wget https://github.com/ZyCromerZ/Clang/releases/download/17.0.0-20230212-release/Clang-17.0.0-20230212.tar.gz -O "Clang-17.0.0-20230212.tar.gz"
tar -xf Clang-17.0.0-20230212.tar.gz -C $ClangPath
}
